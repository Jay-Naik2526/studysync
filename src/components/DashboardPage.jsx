  ...
  return (
    <div className="min-h-screen bg-[#0d1524] text-white p-4 sm:p-6 md:p-8 font-sans">
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-2"><HeaderIcon onClick={() => onNavigate('attendance')}>📅</HeaderIcon><HeaderIcon onClick={() => onNavigate('marks')}>📊</HeaderIcon><HeaderIcon onClick={() => onNavigate('subjects')}>📚</HeaderIcon>
          <HeaderIcon onClick={() => onNavigate('notes')}>📝</HeaderIcon></div>
      </header>
